...
INSERT INTO CURSOS VALUES(NULL,'JAVASCRIPT',30, 500.00);
INSERT INTO CURSOS VALUES(NULL,'BANCO DE DADOS',50, 800.00);
...
CALL CAD_CURSOS('BI SQL SERVER', 35,300.00);
CALL CAD_CURSOS('JAVA', 20,500.00);

/* CRIAR UMA PROCEDURE PARA CONSULTAR CURSOS */ 
DELIMITER $

CREATE PROCEDURE CONS_CURSOS(P_IDCURSO INT)
BEGIN
...
/* SUBQUERIES
. QUAL VALOR, NOME DO VENDEDOR QUE MENOS VENDEU EM MARCO */
...
/* . QUAL VALOR, NOME DO VENDEDOR QUE MAIS VENDEU EM MARCO */
	
SELECT NOME, MARCO FROM VENDEDORES
	WHERE MARCO = (SELECT MAX(MARCO) FROM VENDEDORES);


/* MÉDIA DE QUEM VENDEU MAIS DOQUE A MÉDIA EM MARCO */
	SELECT NOME, FEVEREIRO FROM VENDEDORES
		WHERE FEVEREIRO > (SELECT AVG(MARCO) FROM VENDEDORES);

/* QUEM VENDEU NA MÉDIA DE FEVEREIRO */
SELECT AVG(FEVEREIRO) FROM VENDEDORES;

/* Modificando estrutura de tabelas */
...
/* Adicionando coluna sem posição, vai para a ultima coluna */
ALTER TABLE TABELA
ADD COLUNA VARCHAR(30);

/* Adicionando na posição que deseja */
ALTER TABLE TABELA
ADD COLUMN COLUNA4 VARCHAR(30) NOT NULL UNIQUE
AFTER COLUNA3;

/*MODIFICANDO UM TIPO DE CAMPO*/
ALTER TABLE MODIFY COLUNA2 DATE NOT NULL;
...
/* ORGANIZANDO CHAVES E ACOES CONSTRAINTS */
...
CHANGE COLUMN ID_CLIENT ID_CLIENTE INT;
...
SELECT CONSTRAINT_SCHEMA AS "BANCO",
	...
	WHERE CONSTRAINT_SCHEMA = 'CURSOS';

/* APAGANDO CONSTRAINTS 
COMANDO SÓ É BEM SUCEDIDO SE ESTIVERMOS CONECTADO NO BANCO EM QUESTAO
